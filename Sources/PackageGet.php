	...
	foreach ($sections as $i => $section)
	{
		...
		foreach ($packages as $thisPackage)
		{
			...
			else
			{
				...
				// This package is either not installed, or installed but old.  Is it supported on this version of ezForum?
				...
				if ($thisPackage->exists('author') || isset($default_author))
				{
					...
					{
						// Only put the "mailto:" if it looks like a valid email address.  Some may wish to put a link to an ezForum IM Form or other web mail form.
