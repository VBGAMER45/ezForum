 ...
 * @copyright 2011-2013 Simple Machines
...
function loadProfileFields($force_reload = false)
{
	...
	*/
	...
	$profile_fields = array(
		...
		'skype' => array(
			'type' => 'text',
			'label' => $txt['smi_skype_title'],
			'subtext' => $txt['smi_skype_desc'],
			'size' => 24,
			'input_attr' => array('maxlength="65"'),
			'permission' => 'profile_extra',
		),
		'facebook' => array(
			'type' => 'text',
		...
		'pinterest' => array(
			...
			'subtext' => $txt['smi_pinterest_desc'],
			'size' => 24,
			'input_attr' => array('maxlength="32"'),
			'permission' => 'profile_extra',
		),
...
function forumProfile($memID)
{
	...
	setupProfileContext(
		array(
			...
			'icq', 'yim', 'skype', 'facebook', 'myspace', 'twitter', 'linkedin', 'youtube', 'deviantart', 'pinterest', 'hr',
