...
$txt['scheduled_tasks_time_offset'] = '<strong>Note:</strong> All times given below are <em>server time</em> and do not take any time offsets setup within ezForum into account.';
...
$txt['scheduled_task_fetchSMfiles'] = 'Fetch ezForum Files';
