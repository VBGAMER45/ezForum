...
$txt['manual_introduction'] = 'ezForum&reg; is the free forum software solution that this site is running. It allows users to communicate in discussion topics on a given subject in a clever and organized manner. Furthermore, it has a number of powerful features which end users can take advantage of. Help for many of ezForum\'s features can be found by either clicking the question mark icon next to the relevant section or by selecting one of the links on this page. These links will take you to ezForum\'s centrally-located documentation on the Simple Machines official site.';
$txt['manual_docs_and_credits'] = 'For more information about how to use ezForum, please see the <a href="%1$s" target="_blank" class="new_win">Simple Machines Documentation Wiki</a> and check out the <a href="%2$s">credits</a> to find out who has made ezForum what it is today.';
