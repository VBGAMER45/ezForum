...
$txt['packages_latest_fetch'] = 'Attempting to fetch the most popular and recent packages from www.ezforum.com...';
...
$txt['corrupt_compatible'] = 'The package you are trying to download or install is either corrupt or not compatible with this version of ezForum.';
...
$txt['package_will_fail_warning'] = 'At least one error was encountered during a test installation of this package.
	...
	This error may be caused by a conflict between the package you\'re trying to install and another package you have already installed, an error in the package, a package which requires another package that you don\'t have installed yet, or a package designed for another version of ezForum.';
...
$txt['package_ftp_path'] = 'Local path to ezForum';
...
$txt['package_emulate_desc'] = 'Sometimes packages are locked to early versions of ezForum but remain compatible with a newer version. Here you can choose to &quot;emulate&quot; a different ezForum version within the package manager.';
...
$txt['package_file_perms_predefined_note'] = 'Note that this only applies the predefined profile to key ezForum folders and files.';
...
$txt['package_file_perms_ftp_retain'] = 'Note, ezForum will only retain the password information temporarily to aid operation of the package manager.';
...
$txt['package_restore_permissions_desc'] = 'The following file permissions were changed by ezForum to install the selected package(s). You can return these files back to their original status by clicking &quot;Restore&quot; below.';
...
$txt['package_restore_permissions_action_done'] = 'ezForum has attempted to restore the selected files back to their original permissions, the results can be seen below. If a change failed, or for a more detailed view of file permissions, please see the <a href="%1$s">File Permissions</a> section.';
...
$txt['package_file_perms_warning_desc'] = '
	...
	<li>On some server configurations selecting the wrong permissions may stop ezForum from operating.</li>
