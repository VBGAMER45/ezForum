...
$txt['theme_latest_fetch'] = 'Fetching latest themes from www.ezforum.com...';
...
$txt['themeadmin_edit_copy_warning'] = 'When ezForum needs a template or language file which is not in the current theme, it looks in the theme it is based on, or the default theme.<br />Unless you need to modify a template, it\'s better not to copy it.';
