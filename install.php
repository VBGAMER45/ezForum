...
function DatabasePopulation()
{
	...
	if (isset($_POST['stats']) && substr($_POST['boardurl'], 0, 16) != 'http://localhost')
	{
		...
		if ($fp)
		{
			$out = "GET /ezc/stats/register_stats.php?site=" . base64_encode($_POST['boardurl']) . " HTTP/1.1\r\n";
...
class ftp_connection
{
	...
	function connect($ftp_server, $ftp_port = 21, $ftp_user = 'anonymous', $ftp_pass = 'ftpclient@test.com')
	{
...
function template_install_below()
{
	...
	<div id="footer_section"><div class="frame" style="height: 40px;">
		<div class="smalltext"><a href="http://www.ezforum.com" title="ezForum" target="_blank" class="new_win">ezForum &copy; 2012</a></div>
	</div></div>
	</body>
</html>';
}
...
function template_database_settings()
{
	...
	echo '
			<tr id="db_server_contain">
				...
				<td>
					<input type="text" name="db_name" id="db_name_input" value="', empty($incontext['db']['name']) ? 'ezforum' : $incontext['db']['name'], '" size="30" class="input_text" /><br />
