...
CREATE TABLE {$db_prefix}members (
  ...
  facebook varchar(155) NOT NULL default '',
  twitter varchar(155) NOT NULL default '',
  linkedin varchar(155) NOT NULL default '',
  googleplus varchar(155) NOT NULL default '',
  myspace varchar(155) NOT NULL default '',
  youtube varchar(155) NOT NULL default '',
  deviantart varchar(155) NOT NULL default '',
  pinterest varchar(155) NOT NULL default '',
...
VALUES ('smfVersion', '{$smf_version}'),
	...
	('attachmentExtensions', 'doc,gif,jpg,mpg,pdf,png,txt,zip,docx,xls,xlsx,rar,odt,csv'),
	...
	('warning_moderate', '35'),
	('warning_mute', '60'),
	('admin_features', 'cd,cp,k,ml,pm,ps,rg,w,posthistory'),
...
VALUES (1, 'name', '{$default_theme_name}'),
	...
	(1, 'additional_options_collapsable', '0'),
